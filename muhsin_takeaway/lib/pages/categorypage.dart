            ...
            Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  FadeInUp(duration: const Duration(milliseconds: 1500), child:  makeProduct(image: 'assets/images/beauty-1.jpg', title: 'Beauty', price: '100\$')),
                  FadeInUp(duration: const Duration(milliseconds: 1600), child:  makeProduct(image: 'assets/images/clothes-1.jpg', title: 'Clothes', price: '100\$')),
                  FadeInUp(duration: const Duration(milliseconds: 1700), child:  makeProduct(image: 'assets/images/glass.jpg', title: 'Glass', price: '100\$')),
                  FadeInUp(duration: const Duration(milliseconds: 1800), child:  makeProduct(image: 'assets/images/perfume.jpg', title: 'Perfume', price: '100\$')),
                  FadeInUp(duration: const Duration(milliseconds: 1900), child:  makeProduct(image: 'assets/images/person.jpg', title: 'Person', price: '100\$')),
                ],
              ),
            )
          ],
